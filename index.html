...
<head>
{% include title.html %} 
<base href="https://temek1.github.io/" />
<meta charset="UTF-8">
...
<div class="wrapper row1">
  <div id ="navbar">
	<div id ="nav1">
     <!--#include virtual="navbar.include"-->
	</div>
  </div>
</div>
<div class="wrapper row2">
  <div id="index_container" class="clear">
    <div id="col_1">
	 <!--#include virtual="profile.include"-->
    </div>
	<div id ="col_mobile_talks">
    <!--#include virtual="talks.include"-->
    </div>
    <div id="col_2">
      <h2>Welcome to my personal portfolio.</h2>
	  <p>They call me Turre.</p>
...
<div class="wrapper row3">
  <footer id="footer" class="clear">
    <p class="fl_right"><div id ="footer1">&copy;Thorbjörn Sievert</div></p>
	<div id ="footer2">
	</div>
  </footer>
</div>
